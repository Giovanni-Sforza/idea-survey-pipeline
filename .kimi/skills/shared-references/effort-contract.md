...
```
/skill:any-skill "args" — effort: lite | balanced | max | beast
```
...
| Setting | Value | Why |
|---------|-------|-----|
| Reviewer subagent model | **default** | Reviewer quality is non-negotiable |
...
```
⚡ [effort: max] papers=25, ideas=16, rounds=6 | reviewer: default model (always)
```
